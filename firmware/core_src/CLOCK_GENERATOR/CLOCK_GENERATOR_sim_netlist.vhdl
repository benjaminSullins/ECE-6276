...
--               c:/Users/Ben/Desktop/ECE6276/ECE-6276/firmware/core_src/VGA_CLK_GEN/CLOCK_GENERATOR/CLOCK_GENERATOR_sim_netlist.vhdl
...
architecture STRUCTURE of CLOCK_GENERATOR_CLOCK_GENERATOR_clk_wiz is
  ...
  signal clk_out1_CLOCK_GENERATOR_en_clk : STD_LOGIC;
  signal clk_out2_CLOCK_GENERATOR : STD_LOGIC;
  signal clk_out2_CLOCK_GENERATOR_en_clk : STD_LOGIC;
...
clkout1_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => clk_out1_CLOCK_GENERATOR_en_clk
    );
...
clkout2_buf_en: unisim.vcomponents.BUFH
     port map (
      ...
      O => clk_out2_CLOCK_GENERATOR_en_clk
    );
...
\seq_reg1_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out1_CLOCK_GENERATOR_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg1(0),
      R => '0'
...
\seq_reg2_reg[0]\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
        ...
        port map (
      C => clk_out2_CLOCK_GENERATOR_en_clk,
      CE => '1',
      D => \^locked\,
      Q => seq_reg2(0),
      R => '0'
